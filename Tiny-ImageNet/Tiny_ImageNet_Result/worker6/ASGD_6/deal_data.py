...
if __name__ == "__main__":
    mypath("./deal_data")
    in_dir = ["./data/train_ASGD_0.1_40000_500_6_", "./data/test_ASGD_0.1_40000_500_6_"]
    deal_dir = ["./deal_data/train_ASGD_0.1_40000_500_6_", "./deal_data/test_ASGD_0.1_40000_500_6_"]
