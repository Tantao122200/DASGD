...
if __name__ == "__main__":
    mypath("./msg")
    in_dir = ["./deal_data/train_ASGDMT_0.1_40000_500_6_", "./deal_data/test_ASGDMT_0.1_40000_500_6_"]
    out_dir = ["./msg/train_ASGDMT_0.1_40000_500_6.csv", "./msg/test_ASGDMT_0.1_40000_500_6.csv"]
