...
if __name__ == "__main__":
    mypath("./msg")
    in_dir = ["./deal_data/train_ASGDMK_0.1_40000_500_6_", "./deal_data/test_ASGDMK_0.1_40000_500_6_"]
    out_dir = ["./msg/train_ASGDMK_0.1_40000_500_6.csv", "./msg/test_ASGDMK_0.1_40000_500_6.csv"]
