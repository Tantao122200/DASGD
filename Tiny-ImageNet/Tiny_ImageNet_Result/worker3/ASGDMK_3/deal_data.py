...
if __name__ == "__main__":
    mypath("./deal_data")
    in_dir = ["./data/train_ASGDMK_0.1_40000_500_3_", "./data/test_ASGDMK_0.1_40000_500_3_"]
    deal_dir = ["./deal_data/train_ASGDMK_0.1_40000_500_3_", "./deal_data/test_ASGDMK_0.1_40000_500_3_"]
