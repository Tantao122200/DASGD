...
if __name__ == "__main__":
    ...
    picture("train", train_result[0], train_result[1], train_result[2], train_result[3], train_result[4],
            train_result[5],
            "ASGD_3")
    train_result = pd.read_csv("./train_ASGDMK_0.1_40000_500_3.csv", header=None, usecols=[0, 2, 3, 4, 6, 7]).values.T
    picture("train", train_result[0], train_result[1], train_result[2], train_result[3], train_result[4],
            train_result[5],
            "MDCASGD_3")
    train_result = pd.read_csv("./train_ASGDMT_0.1_40000_500_3.csv", header=None, usecols=[0, 2, 3, 4, 6, 7]).values.T
    picture("train", train_result[0], train_result[1], train_result[2], train_result[3], train_result[4],
            train_result[5],
            "DASGD_3")
